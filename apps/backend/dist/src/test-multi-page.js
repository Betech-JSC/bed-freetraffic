...
async function runTest() {
    ...
    const conn1 = await prisma_1.default.socialConnection.create({
        data: {
            platform: 'facebook',
    ...
    const conn2 = await prisma_1.default.socialConnection.create({
        data: {
            platform: 'facebook',
            workspaceId: workspace.id,
    ...
    const task = await prisma_1.default.automationTask.create({
        data: {
    ...
    await prisma_1.default.postTemplate.create({
        data: {
    ...
    const logs = await prisma_1.default.botLog.findMany({
    ...
    await prisma_1.default.workspace.delete({ where: { id: workspace.id } });
