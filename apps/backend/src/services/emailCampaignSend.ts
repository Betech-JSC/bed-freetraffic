...
export async function sendEmailCampaign(campaignId: number): Promise<SendCampaignResult> {
...
export async function dispatchDueEmailCampaigns(limit = 10): Promise<number> {
