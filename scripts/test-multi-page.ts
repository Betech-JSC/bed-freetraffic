...
import { executeAutomationTask } from '../apps/backend/src/workers/botEngine';
...
async function runTest() {
  ...
  // Lưu ý: Các Mock Token sẽ bị lỗi kết nối Graph API thực, nên status logs ghi nhận SUCCESS hay ERROR đều được, 
  // miễn là có 2 logs riêng biệt được sinh ra cho từng Page là kiểm thử Đạt.
  if (logs.length === 2) {
